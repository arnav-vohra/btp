...
Host::Host()
{
	...
	t_arrival=random_num(80,200);						//seconds
...
int main()
{
	...
	{	
		...
		if(iterations!=1)
		{
			...
			{
				c = (targetSystemLoad*sumCapacity - sumWeight)*0.85;
			...
			{
				c = 0;
				h = (sumWeight/targetSystemLoad- sumWeight/systemLoad)/60.00;
